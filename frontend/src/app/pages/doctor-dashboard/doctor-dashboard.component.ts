...
import { User, PregnancyProfile, Appointment, Symptom, Medication, DoctorAdvice } from '../../core/models/models';
...
export class DoctorDashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.apiService.getPatientsByDoctor(doctorId).subscribe({
      next: (patients) => {
        this.patients = patients;
        this.loading = false;
        // Load symptoms for all patients to get flagged count
        patients.forEach(p => {
