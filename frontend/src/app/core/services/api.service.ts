...
export class ApiService {
  ...
  getPregnancyProfilesByDoctor(doctorId: number, page = 0, size = 50): Observable<PageResponse<PregnancyProfile>> {
    return this.http.get<PageResponse<PregnancyProfile>>(`${this.api}/pregnancy-profiles/doctor/${doctorId}`, { params: { page, size } });
  }
  ...
  activateMedication(id: number): Observable<Medication> {
    return this.http.patch<Medication>(`${this.api}/medications/${id}/activate`, {});
  }
