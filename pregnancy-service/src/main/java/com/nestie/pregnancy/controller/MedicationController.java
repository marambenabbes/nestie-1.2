...
public class MedicationController {
    ...
    @Operation(summary = "Activate medication")
    public ResponseEntity<MedicationDTO.Response> activate(@PathVariable Long id) {
        return ResponseEntity.ok(medicationService.activate(id));
    }
